...
const Signup = () => {
  ...
  async function handleSignup(e) {
    ...
    try {
      ...
      const response = await fetch("https://sarthak-sir-repo.onrender.com/api/createUser", {
        method: 'POST',
        headers: {
...
const Signup = () => {
  ...
  async function handleSignup(e) {
    ...
    try {
      ...
      const response = await axios.post("https://sarthak-sir-repo.onrender.com/api/createUser", requestBody);
